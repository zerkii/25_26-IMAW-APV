        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="ejercicios/ejercicio5.php">ACT5 - Formularios</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="ejercicios/ejercicio6.php">ACT6 - Cookies</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="ejercicios/ejercicio7.php">ACT7 - Ejercicio Final</a>
              </li>
            </ul>
