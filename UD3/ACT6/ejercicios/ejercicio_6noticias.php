...
if (!isset($_SESSION['usuario']) && isset($_COOKIE['usuario'])) {
    // Si existe, se reactiva la sesión a partir de la cookie
    $_SESSION['usuario'] = $_COOKIE['usuario'];
}

// 2. Si AÚN NO hay sesión, redirigir al login
...
if (!isset($_COOKIE['tiempo'])) {
    ...
    // Si la cookie aún es válida, debe renovarse para extender el tiempo de actividad
...
<head>
    <meta charset="UTF-8">
    <title>Noticias - Sociedad Gastronómica</title>
...
<body class="d-flex flex-column h-100">
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link activo" href="<?php echo $PAGINA_NOTICIAS; ?>">Noticias Internas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo $PAGINA_RESERVAS; ?>">Reservas</a>
                    </li>
    ...
    <main class="flex-shrink-0" style="padding-top: 70px;">
        <div class="container">
            ...
            <p>En la sociedad en la que nos encontramos algo huele mal!!</p>
            <p>Este es el contenido restringido de la sección de Noticias.</p>
        </div>
    </main>
</body>
</html>